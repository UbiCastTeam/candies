...
KEYBOARD_MAPS = {
    'de_maj': (
        (Key('Ö', c_evt='Odiaeresis'), Key('Ä', c_evt='Adiaeresis'), Key('Ü', c_evt='Udiaeresis'),
         Key(u'^', c_evt='asciicircum'), Key(u'¨', c_evt='diaeresis'), Key(u'~', c_evt='asciitilde')),
        (Key('1'), Key('2'), Key('3'), Key('4'), Key('5'), Key('6'), Key('7'),
         Key('8'), Key('9'), Key('0'), Key('←', nb=2, c_evt='BackSpace')),
        (Key('Q'), Key('W'), Key('E'), Key('R'), Key('T'), Key('Z'), Key('U'),
         Key('I'), Key('O'), Key('P'), Key('\'', c_evt='quoteright')),
        (Key('A'), Key('S'), Key('D'), Key('F'), Key('G'), Key('H'),
         Key('J'), Key('K'), Key('L'), Key(',', c_evt='comma')),
        (NoClKey('⇧', nb=2, evt='de_min'), Key('Y'), Key('X'), Key('C'), Key('V'), Key('B'),
         Key('N'), Key('M'), Key('.', c_evt='period'), NoClKey('⇧', nb=3, evt='de_min')),
        (NoClKey('#+-', nb=2, evt='de_caract'), Key(' ', nb=8, c_evt='space'))
    ),

    'fr_maj': (
        (Key('À', c_evt='Agrave'), Key('Ç', c_evt='Ccedilla'), Key('É', c_evt='Eacute'), Key('È', c_evt='Egrave'),
         Key('Ù', c_evt='Ugrave'), Key(u'^', c_evt='asciicircum'), Key(u'¨', c_evt='diaeresis'), Key(u'~', c_evt='asciitilde'), Key('ß')),
        (Key('1'), Key('2'), Key('3'), Key('4'), Key('5'), Key('6'), Key('7'),
         Key('8'), Key('9'), Key('0'), Key('←', nb=2, c_evt='BackSpace')),
        (Key('A'), Key('Z'), Key('E'), Key('R'), Key('T'), Key('Y'), Key('U'),
         Key('I'), Key('O'), Key('P'), Key('\'', c_evt='quoteright')),
        (Key('Q'), Key('S'), Key('D'), Key('F'), Key('G'),
         Key('H'), Key('J'), Key('K'), Key('L'), Key('M')),
        (NoClKey('⇧', nb=2, evt='fr_min'), Key('W'), Key('X'), Key('C'), Key('V'), Key('B'), Key('N'),
         Key(',', c_evt='comma'), Key('.', c_evt='period'), NoClKey('⇧', nb=3, evt='fr_min')),
    ...
    'en_maj': (
        ...
        (Key('A'), Key('S'), Key('D'), Key('F'), Key('G'), Key('H'),
         Key('J'), Key('K'), Key('L'), Key(',', c_evt='comma')),
        (NoClKey('⇧', nb=2, evt='en_min'), Key('Z'), Key('X'), Key('C'), Key('V'), Key('B'),
         Key('N'), Key('M'), Key('.', c_evt='period'), NoClKey('⇧', nb=3, evt='en_min')),
        (NoClKey('#+-', nb=2, evt='en_caract'), Key(' ', nb=8, c_evt='space'))
    ),

    'de_min': (
        (Key('ö', c_evt='odiaeresis'), Key('ä', c_evt='adiaeresis'), Key('ü', c_evt='udiaeresis'),
         Key(u'^', c_evt='asciicircum'), Key(u'¨', c_evt='diaeresis'), Key(u'~', c_evt='asciitilde'), Key('ß')),
        (Key('1'), Key('2'), Key('3'), Key('4'), Key('5'), Key('6'), Key('7'),
         Key('8'), Key('9'), Key('0'), Key('←', nb=2, c_evt='BackSpace')),
        (Key('q'), Key('w'), Key('e'), Key('r'), Key('t'), Key('z'), Key('u'),
         Key('i'), Key('o'), Key('p'), Key('\'', c_evt='quoteright')),
        (Key('a'), Key('s'), Key('d'), Key('f'), Key('g'), Key('h'),
         Key('j'), Key('k'), Key('l'), Key(',', c_evt='comma')),
        (NoClKey('⇧', nb=2, evt='de_maj'), Key('y'), Key('x'), Key('c'), Key('v'), Key('b'),
         Key('n'), Key('m'), Key('.', c_evt='period'), NoClKey('⇧', nb=3, evt='de_maj')),
        (Key('#+-', nb=2, evt='de_caract'), Key(' ', nb=8, c_evt='space'))
    ),

    'fr_min': (
        (Key('à', c_evt='agrave'), Key('ç', c_evt='ccedilla'), Key('é', c_evt='eacute'), Key('è', c_evt='egrave'),
         Key('ù', c_evt='ugrave'), Key(u'^', c_evt='asciicircum'), Key(u'¨', c_evt='diaeresis'), Key(u'~', c_evt='asciitilde'), ),
        (Key('1'), Key('2'), Key('3'), Key('4'), Key('5'), Key('6'), Key('7'),
         Key('8'), Key('9'), Key('0'), Key('←', nb=2, c_evt='BackSpace')),
        (Key('a'), Key('z'), Key('e'), Key('r'), Key('t'), Key('y'), Key('u'),
         Key('i'), Key('o'), Key('p'), Key('\'', c_evt='quoteright')),
        (Key('q'), Key('s'), Key('d'), Key('f'), Key('g'),
         Key('h'), Key('j'), Key('k'), Key('l'), Key('m')),
        (NoClKey('⇧', nb=2, evt='fr_maj'), Key('w'), Key('x'), Key('c'), Key('v'), Key('b'), Key('n'),
         Key(',', c_evt='comma'), Key('.', c_evt='period'), NoClKey('⇧', nb=3, evt='fr_maj')),
    ...
    'en_min': (
        ...
        (Key('a'), Key('s'), Key('d'), Key('f'), Key('g'), Key('h'),
         Key('j'), Key('k'), Key('l'), Key(',', c_evt='comma')),
        (NoClKey('⇧', nb=2, evt='en_maj'), Key('z'), Key('x'), Key('c'), Key('v'), Key('b'),
         Key('n'), Key('m'), Key('.', c_evt='period'), NoClKey('⇧', nb=3, evt='en_maj')),
        (NoClKey('#+-', nb=2, evt='en_caract'), Key(' ', nb=8, c_evt='space'))
    ),

    'de_caract': (
        (Key('\'', c_evt='quoteright'), Key('.', c_evt='period'), Key(',', c_evt='comma'), Key(';', c_evt='semicolon'),
         Key(':', c_evt='colon'), Key('/', c_evt='slash'), Key('?', c_evt='question'), Key('!', c_evt='exclam'), Key('%', c_evt='percent'),),
        (Key('*', c_evt='asterisk'), Key('+', c_evt='plus'), Key('-', c_evt='minus'), Key('=', c_evt='equal'), Key('#', c_evt='numbersign'),
         Key('~', c_evt='asciitilde'), Key('@', c_evt='at'), Key('\\', c_evt='backslash'), Key('_', c_evt='underscore')),
        (Key('`', c_evt='quoteleft'), Key('|', c_evt='bar'), Key('(', c_evt='parenleft'), Key(')', c_evt='parenright'),
         Key('"', c_evt='quotedbl'), Key('&', c_evt='ampersand'), Key('[', c_evt='bracketleft'), Key(']', c_evt='bracketright')),
        (NoClKey('ABC', nb=2, evt='de_maj'), Key('<', c_evt='less'), Key('$', c_evt='dollar'),
         Key('>', c_evt='greater'), Key('←', nb=2, c_evt='BackSpace')),
    ...
    'fr_caract': (
        ...
        (Key('`', c_evt='quoteleft'), Key('|', c_evt='bar'), Key('(', c_evt='parenleft'), Key(')', c_evt='parenright'),
         Key('"', c_evt='quotedbl'), Key('&', c_evt='ampersand'), Key('[', c_evt='bracketleft'), Key(']', c_evt='bracketright')),
        (NoClKey('ABC', nb=2, evt='fr_maj'), Key('<', c_evt='less'), Key('$', c_evt='dollar'),
         Key('>', c_evt='greater'), Key('←', nb=2, c_evt='BackSpace')),
    ...
    'en_caract': (
        ...
        (Key('`', c_evt='quoteleft'), Key('|', c_evt='bar'), Key('(', c_evt='parenleft'), Key(')', c_evt='parenright'),
         Key('"', c_evt='quotedbl'), Key('&', c_evt='ampersand'), Key('[', c_evt='bracketleft'), Key(']', c_evt='bracketright')),
        (NoClKey('ABC', nb=2, evt='en_maj'), Key('<', c_evt='less'), Key('$', c_evt='dollar'),
         Key('>', c_evt='greater'), Key('←', nb=2, c_evt='BackSpace')),
    ...
    'hexa': (
        ...
        (Key('-', c_evt='minus'), None, Key('0'),
         None, Key('←', c_evt='BackSpace'))
    )
}
...
class Keyboard(Clutter.Actor, Clutter.Container):
    ...
    __gsignals__ = {
        'keyboard': (GObject.SIGNAL_RUN_LAST, GObject.TYPE_NONE, [GObject.TYPE_STRING])}
    ...
    def _key_press_event(self, event):
        ...
        # Alt Backspace or Escape Backspace: delete previous word (bounded by a
        ...
        if not ignored_masks & event.modifier_state and (event.unicode_value in ctrl_keys or (Clutter.CONTROL_MASK & event.modifier_state and event.hardware_keycode in arrow_keys)):
            if event.unicode_value == CTRL_C:
                ...
                self.move_cursor_left(type_="word", select=bool(
                    Clutter.SHIFT_MASK & event.modifier_state))
            elif event.hardware_keycode == RIGHT_ARROW:
                self.move_cursor_right(type_="word", select=bool(
                    Clutter.SHIFT_MASK & event.modifier_state))
            ...
            if event.hardware_keycode == LEFT_ARROW:  # left arrow
                self.move_cursor_left(
                    select=bool(Clutter.SHIFT_MASK & event.modifier_state))
            else:  # right arrow
                self.move_cursor_right(
                    select=bool(Clutter.SHIFT_MASK & event.modifier_state))
        else:
            if event.unicode_value in DEAD_KEYS:
                self._dead_key = event.keyval, event.unicode_value, DEAD_KEYS[
                    event.unicode_value]
            else:
                emit_key = True
    ...
    # keyboard load profile: load a mapping dictionnary, create buttons and
    # calcul max line width
    ...
    def connect_Clutter_text(self, text_actor):
        ...
        self._text_actor.connect(
            "notify::position", self._on_text_actor_position_changed)
        self._text_actor.connect(
            "notify::selection-bound", self._on_text_actor_selection_bound_changed)
        self._text_actor.connect(
            "button-press-event", self._on_text_actor_press)
        self._text_actor.connect(
            "button-release-event", self._on_text_actor_release)
    ...
    def _on_text_actor_position_changed(self, source, position):
        if self._middle_click:
            ...
            if self._next_position == -1:
                ...
                min_bound = min(
                    self._next_position, self._next_selection_bound)
                max_bound = max(
                    self._next_position, self._next_selection_bound)
            if self._next_position != -1 and self._next_selection_bound != -1 and self._next_position != self._next_selection_bound and min_bound <= new_position <= max_bound:
                ...
                if self._next_selection_bound != -1:
                    self._next_selection_bound += len(
                        self._clipboards["secondary"])
    ...
    def _emit_key_press(self, keyval, unival=None):
        if self._text_actor:
            ...
            event.keyval = keyval
            event.unicode_value = unival or int(
                Clutter.keysym_to_unicode(event.keyval))
            # self._text_actor.emit('key-press-event', event)
            ...
            if self._keyboard_repeat_id:
                ...
                self._keyboard_repeat_id = None
            self._keyboard_delay_id = GObject.timeout_add(
                self.REPEAT_DELAY_MS, self._key_delay, event)
            self._key_press_event(event)
    ...
    def _key_delay(self, event):
        ...
        if self._keyboard_repeat_id:
            GObject.source_remove(self._keyboard_repeat_id)
        self._keyboard_repeat_id = GObject.timeout_add(
            self.REPEAT_RATE_MS, self._key_repeat, event)
        return False
    ...
    def move_cursor_left(self, type_="char", select=False, *args, **kwargs):
        ...
        if type_ == "word":
            if select:
                selection_bound = self._get_previous_word_position(
                    bound="alphanumeric")
            else:
                selection_bound = cursor_pos = self._get_previous_word_position(
                    bound="alphanumeric")
        else:  # char
            if select:
    ...
    def move_cursor_right(self, type_="char", select=False, *args, **kwargs):
        ...
        if type_ == "word":
            if select:
                selection_bound = self._get_next_word_position(
                    bound="alphanumeric")
            else:
                selection_bound = cursor_pos = self._get_next_word_position(
                    bound="alphanumeric")
        else:  # char
            if select:
    ...
    def delete_previous_word(self, bound="whitespace"):
        ...
        self._text_actor.set_selection_bound(
            previous_word_position + max_pos - min_pos)
    ...
    def _refresh_allocation_params(self):
        if self._columns_count > 0:
            button_width = int(
                float(self._width - self._columns_count * self._spacing.x + self._spacing.x) / self._columns_count)
            button_height = int(
                float(self._height - len(self._lines) * self._spacing.y + self._spacing.y) / len(self._lines))
            self._button_size = min(button_width, button_height)

            self._padding_y = int(
                float(self._height - len(self._lines) * (self._button_size + self._spacing.y) + self._spacing.y) / 2.0)

            for line in self._lines:
                line.padding_x = int(
                    float(self._width - line.width * (self._button_size + self._spacing.x) + self._spacing.x) / 2.0)
                line.padding_y = self._padding_y + \
                    self._lines.index(line) * (
                        self._button_size + self._spacing.y)
        ...
        for line in self._lines:
            ...
            for button in line.buttons:
                ...
                if button.kb_width < 1:
                    ...
                    btn_box.x2 = x + button.kb_width * \
                        (self._button_size + self._spacing.x) - self._spacing.x
