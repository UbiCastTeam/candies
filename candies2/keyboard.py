...
KEYBOARD_MAPS = {
    'de_maj': (
        (Key('Ö',c_evt='Ouml'), Key('Ä',c_evt='Auml'), Key('Û',c_evt='uuml'), Key(u'^',c_evt='asciicircum'), Key(u'¨',c_evt='diaeresis'), Key(u'~',c_evt='asciitilde')), 
    ...
    'de_min': (
    	(Key('ö',c_evt='ouml'), Key('ä',c_evt='auml'), Key('ü',c_evt='uuml'), Key(u'^',c_evt='asciicircum'), Key(u'¨',c_evt='diaeresis'), Key(u'~',c_evt='asciitilde'), Key('ß')),
    	(Key('1'), Key('2'), Key('3'), Key('4'), Key('5'), Key('6'), Key('7'), Key('8'), Key('9'), Key('0'), Key('←',nb=2,c_evt='BackSpace')),
        (Key('q'), Key('w'), Key('e'), Key('r'), Key('t'), Key('z'), Key('u'), Key('i'), Key('o'), Key('p'), Key('\'',c_evt='quoteright')),
        (Key('a'), Key('s'), Key('d'), Key('f'), Key('g'), Key('h'), Key('j'), Key('k'), Key('l'), Key(',',c_evt='comma')),
