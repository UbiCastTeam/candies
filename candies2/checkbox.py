...
class CheckBox(BaseContainer):
    ...
    def do_get_preferred_width(self, for_height):
        preferred_width = self._image_size + self.spacing + \
            self._label.get_preferred_width(for_height)[1]
        return preferred_width, preferred_width

    def do_get_preferred_height(self, for_width):
        preferred_height = max(self._image_size, self._label.get_preferred_height(
            for_width)[1])
